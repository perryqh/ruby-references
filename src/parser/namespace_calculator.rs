...
pub(crate) fn calculate_module_nesting(namespace_nesting: &[&str]) -> Vec<String> {
...
pub fn combine_namespace_with_constant_name(namespace_path: &[&str], const_name: &str) -> String {
